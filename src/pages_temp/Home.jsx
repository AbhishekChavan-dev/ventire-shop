    ...
    <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 border-b border-green-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          {/* DESKTOP MENU */}
          <div className="hidden md:flex items-center space-x-8">
            <button onClick={() => goTo("/")} className="text-gray-600 hover:text-green-600">
              Home
            </button>

            <button onClick={() => goTo("/#features")} className="text-gray-600 hover:text-green-600">
              Technology
            </button>

            <button onClick={() => goTo("/#product")} className="text-gray-600 hover:text-green-600">
              Shop
            </button>

            <button onClick={() => goTo("/#reviews")} className="text-gray-600 hover:text-green-600">
              Reviews
            </button>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 absolute w-full">
          <div className="px-4 pt-2 pb-6 space-y-2 shadow-lg">
            ...
            <button
              onClick={() => goTo("/")}
              className="block w-full text-left px-3 py-2 text-gray-600 hover:bg-green-50 rounded-md"
            >
              Home
            </button>
            ...
            <Link
              ...
              className="mt-4 block bg-green-600 text-white text-center px-5 py-3 rounded-lg"
            >
              Cart ({cart.quantity})
            </Link>
